...
public class C06_ComputeMethodlari {
    ...
    public static void main(String[] args) {
       ...
       Integer valueA=harfler.get("A");//A'nin value'sunu aldim
       ...
       System.out.println(harfler);//{A=29, C=12, Y=28, K=15}
        ...
        harfler.compute("A",(k,v)->v+10);//(k,v)=(key, value)
        System.out.println(harfler);//{A=39, C=12, Y=56, K=15}

        //SORU:X'in degerini 10 artirin
        // harfler.compute("X", (k,v)-> v+10); // NullPointerException   cunku X diye bir key yok
