...
public class C03_Scope_ClassVariables {
    ...
    /*
        ...
        static keyword'u sadece class level'deki variable'lar icin kullanilir.
        static keyword'u local variable'lar icin KULLANILMAZ.

        static keyword'e sahip olan variable'lar tum class icinden direk kullanilabilir

        static methodlar sadece static variable'lari kabul eder,instance'lari kabul etmezler.
        static olmayan methodlar her turlu variable'i kabul eder.

        static keyword kullanmayan variable'lar (instance variable'lar)
