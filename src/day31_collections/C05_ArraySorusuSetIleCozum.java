...
public class C05_ArraySorusuSetIleCozum {
    public static void main(String[] args) {
        ...
        Set <Integer> tekrarsizSet=new TreeSet<>();//Unique elementli ve dogal sirali olacak
        ...
        arr=new int[tekrarsizSet.size()];//yeni bir array olusturuyoruz
        // for-each loop ile yapacagimiz icin array'in index'ini biz takip etmeliyiz.
        int index=0;
        for (Integer each:tekrarsizSet
             ) {
            arr[index]=each;
            index++;//0.indexten baslayip tum indexleri tek tek atamasi icin indexi takip ediyoruz.Burasi arr'nin index takibini yapar
        }
