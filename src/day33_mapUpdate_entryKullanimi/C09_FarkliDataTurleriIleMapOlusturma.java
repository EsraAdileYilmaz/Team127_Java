...
public class C09_FarkliDataTurleriIleMapOlusturma {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(((String)ornekMap.get("body")).toUpperCase());//BAR (value'muzun data turu Object oldugu icin String'e cast ettik)
        ...
        //SORU:id'yi 1 artir
        System.out.println(ornekMap.get("id"));//101 (once value'nun ne oldugunu integer,String vs gormek istiyorum)
        Integer idDeger=(Integer)ornekMap.get("id");//(value'muzun data turu Object oldugu icin Integer'a cast ettik)
        ...
        //isUpperCase() methodu ile (buyuk harf mi?) sorusuna cvp buluruz.true veya false dondurur
        System.out.println(Character.isUpperCase((Character) ornekMap.get("initial")));//(value'muzun data turu Object oldugu icin Character'a cast ettik)
        //value'yu Character'e cevir ve buyuk harf mi kontrol et.
        ...
        Integer userId=(Integer)ornekMap.get("userId");//int oldugu gorulen value'yu int'e cast edilir.(value'muzun data turu Object oldugu icin Integer'a cast ettik)
